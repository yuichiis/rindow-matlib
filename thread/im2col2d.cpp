    ...
    )
{
    ...
    switch(dtype) {
        case rindow_matlib_dtype_float32: {
            errcode = Im2col2d<float>::execute(
                reverse,
                (float*)images_data,images_size,
                batches,im_h,im_w,channels,
                filter_h,filter_w,stride_h,stride_w,padding,
                channels_first,
        ...
        case rindow_matlib_dtype_float64: {
            errcode = Im2col2d<double>::execute(
                reverse,
        ...
        case rindow_matlib_dtype_int8: {
            errcode = Im2col2d<int8_t>::execute(
                reverse,
        ...
        case rindow_matlib_dtype_uint8: {
            errcode = Im2col2d<uint8_t>::execute(
                reverse,
        ...
        case rindow_matlib_dtype_int16: {
            errcode = Im2col2d<int16_t>::execute(
                reverse,
        ...
        case rindow_matlib_dtype_uint16: {
            errcode = Im2col2d<uint16_t>::execute(
                reverse,
        ...
        case rindow_matlib_dtype_int32: {
            errcode = Im2col2d<int32_t>::execute(
                reverse,
        ...
        case rindow_matlib_dtype_uint32: {
            errcode = Im2col2d<uint32_t>::execute(
                reverse,
        ...
        case rindow_matlib_dtype_int64: {
            errcode = Im2col2d<int64_t>::execute(
                reverse,
        ...
        case rindow_matlib_dtype_uint64: {
            errcode = Im2col2d<uint64_t>::execute(
                reverse,
