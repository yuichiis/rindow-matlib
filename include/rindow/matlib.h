...
#define RINDOW_MATLIB_E_SOME_EXCEPTION_OCCURRED -110
...
RINDOW_FUNC_DECL void rindow_matlib_d_topk(int32_t m, int32_t n, const double *input, int32_t k, int32_t sorted, double *values, int32_t *indices);
