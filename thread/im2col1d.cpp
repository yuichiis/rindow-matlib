...
private:
    ...
    )
    {
        ...
        for(int32_t batch = cell.begin; batch < cell.end; batch++) {
            int32_t stride_w_pos = batch_pos+batch*batch_step;
...
public:
    ...
    {
        if((batches*im_w*channels)!=images_size) {
        ...
        int32_t out_cell_step = filter_w*channels;
        int32_t batch_out_step = out_w*out_cell_step;

        int32_t batch_pos = -im_w_step*padding_w;
    ...
    )
{
    ...
    switch(dtype) {
        case rindow_matlib_dtype_float32: {
            errcode = Im2col1d<float>::execute(
                reverse,
                (float*)images_data,images_size,
                batches,im_w,channels,
                filter_w,stride_w,padding,
                channels_first,
                dilation_w,
                cols_channels_first,
        ...
        case rindow_matlib_dtype_float64: {
            errcode = Im2col1d<double>::execute(
                reverse,
        ...
        case rindow_matlib_dtype_int8: {
            errcode = Im2col1d<int8_t>::execute(
                reverse,
        ...
        case rindow_matlib_dtype_uint8: {
            errcode = Im2col1d<uint8_t>::execute(
                reverse,
        ...
        case rindow_matlib_dtype_int16: {
            errcode = Im2col1d<int16_t>::execute(
                reverse,
        ...
        case rindow_matlib_dtype_uint16: {
            errcode = Im2col1d<uint16_t>::execute(
                reverse,
        ...
        case rindow_matlib_dtype_int32: {
            errcode = Im2col1d<int32_t>::execute(
                reverse,
        ...
        case rindow_matlib_dtype_uint32: {
            errcode = Im2col1d<uint32_t>::execute(
                reverse,
        ...
        case rindow_matlib_dtype_int64: {
            errcode = Im2col1d<int64_t>::execute(
                reverse,
        ...
        case rindow_matlib_dtype_uint64: {
            errcode = Im2col1d<uint64_t>::execute(
                reverse,
